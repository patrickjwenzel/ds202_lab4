...
tackles<- aggregate(iowaVSnotreDame$value ~ iowaVSnotreDame$teams , data=iowaVSnotreDame, sum)
averagetackles<- aggregate(iowaVSnotreDame$value ~ iowaVSnotreDame$teams , data=iowaVSnotreDame, mean)
print(tackles)
print(averagetackles)
